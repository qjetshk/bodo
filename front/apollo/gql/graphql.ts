...
export type MutationMoveTaskToAnotherColumnArgs = {
  curColTasks: Array<ChangeTaskOrderInput>;
  prevColTasks: Array<ChangeTaskOrderInput>;
};
...
export type MoveTaskToAnotherColumnMutationVariables = Exact<{
  curColTasks: Array<ChangeTaskOrderInput> | ChangeTaskOrderInput;
  prevColTasks: Array<ChangeTaskOrderInput> | ChangeTaskOrderInput;
}>;
...
export const MoveTaskToAnotherColumnDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MoveTaskToAnotherColumn"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"curColTasks"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ChangeTaskOrderInput"}}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"prevColTasks"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ChangeTaskOrderInput"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"moveTaskToAnotherColumn"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"curColTasks"},"value":{"kind":"Variable","name":{"kind":"Name","value":"curColTasks"}}},{"kind":"Argument","name":{"kind":"Name","value":"prevColTasks"},"value":{"kind":"Variable","name":{"kind":"Name","value":"prevColTasks"}}}]}]}}]} as unknown as DocumentNode<MoveTaskToAnotherColumnMutation, MoveTaskToAnotherColumnMutationVariables>;
