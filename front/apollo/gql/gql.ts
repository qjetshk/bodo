...
const documents: Documents = {
    ...
    "\n    mutation MoveTaskToAnotherColumn(\n        $movedTaskId: String!\n        $newIndex: Int!\n        $prevColumnId: String!\n        $curColumnId: String!\n    ) {\n        moveTaskToAnotherColumn(\n            curColumnId: $curColumnId\n            movedTaskId: $movedTaskId\n            prevColumnId: $prevColumnId\n            newIndex: $newIndex\n        )\n    }\n\n": types.MoveTaskToAnotherColumnDocument,
    "\n    subscription TaskMovedToAnotherColumn {\n        taskMovedToAnotherColumn {\n            currentColumn {\n                columnId\n                tasks {\n                    id\n                    order\n                }\n            }\n            prevColumn {\n                columnId\n                tasks {\n                    id\n                    order\n                    columnId\n                }\n            }\n        }\n    }\n": types.TaskMovedToAnotherColumnDocument,
