...
import { Dialog, DialogClose, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle } from '../../../shared/ui-kit/dialog'
...
import { EditBoardForm } from '@/entities/board/model/edit-board-form-type'
...
import { DELETE_BOARD, EDIT_BOARD } from '@/shared/api/graphql/requests/boards'
