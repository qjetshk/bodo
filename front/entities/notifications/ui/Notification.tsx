...
import { GetAllUserBoardInvitationQuery } from '@/shared/api/graphql/gql/graphql'
import { Avatar, AvatarFallback, AvatarImage } from '../../../shared/ui-kit/avatar'
import { getAvatarFallback } from '@/shared/lib/avatar-fallback.util'
import { Button } from '../../../shared/ui-kit/button'
import { useMutation } from '@apollo/client/react'
import { ACCEPT_INVITATION, DECLINE_INVITATION, GET_ALL_USER_BOARD_INVITATIONS } from '@/shared/api/graphql/requests/invitation'
