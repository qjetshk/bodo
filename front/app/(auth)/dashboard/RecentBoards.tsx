...
const RecentBoards = ({ boards }: Props) => {
    ...
    return (
        <div className="relative xl:px-[15%] px-[5%] lg:px-[10%] 2xl:px-[20%]"> 
            ...
            >
                {!isSearchingBoards && <Label className='font-unbounded font-semibold text-2xl pl-3'>Недавние доски</Label>}
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-5 p-1">
                    ...
                    )) : <div className='text-center col-span-full text-neutral-400'>Ничего не найдено</div>) :
